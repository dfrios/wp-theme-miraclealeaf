      ...
      <section id="contacto" class="py-12 sm:pt-20">
        <div class="max-w-7xl mx-auto px-10 lg:px-32">
          ...
          <form class="mt-10" method="post">
            ...
            <textarea id="message" placeholder="Mensaje" rows="10" class="py-3 my-2 w-full bg-beige px-3 focus:outline-none focus:ring focus:ring-offset-2 focus:ring-brown focus:ring-opacity-50"></textarea>
            <div id="div-btn-contact">
              <button id="btn-contact" type="submit" class="btn-primary">Enviar</button>
            </div>
          </form>
        </div>
      </section>
